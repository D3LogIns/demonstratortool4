...
//*************************************************************
//*******default当前设置为480x272像素lcd******************************
//*************************************************************
//TFT 800480
#define LCD_XSIZE_TFT_800480 	(480)	
#define LCD_YSIZE_TFT_800480 	(272)
...
//tft 800480
#define HOZVAL_TFT_800480	(LCD_XSIZE_TFT_800480-1)  //SCR_XSIZE_TFT_800480
#define LINEVAL_TFT_800480	(LCD_YSIZE_TFT_800480-1)

//tft 800480 
#define CLKVAL_TFT_800480 	(6)   //2   H总频约为104~110Mhz???93Mhz

//Timing of lq085 tft
#define VBPD_800480     (3)  //3
#define VFPD_800480	    (1)	 //1
#define VSPW_800480		(2)  //2
#define HBPD_800480		(15) //15
#define HFPD_800480		(15) //15
#define HSPW_800480		(2)  //4
//*************************************************************
//****************end*************************************
//************************************************************
//STN
...
//I changed 2008-4-2
extern U32 (*frameBuffer16BitTft800480)[SCR_XSIZE_TFT_800480];
