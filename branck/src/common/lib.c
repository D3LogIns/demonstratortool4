...
void Port_Init(void)
{
    ...
    rGPACON =  0x7fffff;   //0x5fffff;   2008-4-28
...
*/
    ...
    rGPHCON = 0x2afaaa; //0x2adaa0;    //rGPHCON = 0x2adaaa;
...
////////////根据send byte改编////////////////////////////////////////////
//=====================================================================
void Uart_Communication(U8 *s)				//默认选串口0
{
    U8 i;
